...
module.exports = {
  data: new SlashCommandBuilder().setName("hug").setDescription("Hug someone").addUserOption((option) =>
  ...
  async execute(interaction) {
    ...
    Tenor.Search.Query("hug", "10")
      .then((Results) => {
        ...
        interaction.reply(responseFinal.itemurl) && interaction.channel.send(`${interaction.member} hugs ${user}`);
      })
      .catch(console.error);
  },
};
