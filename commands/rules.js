...
const { diamond } = require("../botconfig/emojis.json")
module.exports = {
  ...
  async execute(interaction) {
    ...
    interaction.channel.send(`@everyone to gain access to our server, please react to the message above.`);
  },
};
